    ...
    <div className="absolute inset-0 z-0 overflow-hidden bg-[#0A1128]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute -left-1/4 -top-1/4 w-full h-full rounded-full blur-[120px]"
          style={{ background: 'radial-gradient(circle, #A8C97F 0%, transparent 70%)' }}
        />
        ...
        <motion.div
          ...
          className="absolute -right-1/4 -bottom-1/4 w-full h-full rounded-full blur-[150px]"
          style={{ background: 'radial-gradient(circle, #33A6B8 0%, transparent 70%)' }}
        />
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <Ripple delay={0} size={500} duration={12} color="rgba(255, 255, 255, 0.15)" />
        <Ripple delay={4} size={500} duration={12} color="rgba(255, 255, 255, 0.1)" />
        <Ripple delay={8} size={500} duration={12} color="rgba(255, 255, 255, 0.05)" />
